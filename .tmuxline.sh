...
setw -g window-status-current-format "#[fg=colour23,bg=colour29,nobold,nounderscore,noitalics]#[fg=colour231,bg=colour29] #F#I: #W #P #[fg=colour29,bg=colour23,nobold,nounderscore,noitalics]"
