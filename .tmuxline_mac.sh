...
set -g status-right "#[fg=colour23,bg=colour23,nobold,nounderscore,noitalics]#[fg=colour231,bg=colour23] %a %b %d %H:%M #[fg=colour29,bg=colour23,nobold,nounderscore,noitalics]#[fg=colour231,bg=colour29] #(whoami)@#h #[fg=colour36,bg=colour29,nobold,nounderscore,noitalics]#[fg=colour231,bg=colour36] #(uptime | cut -d \" \" -f 5,6 | cut -d \",\" -f 1) "
